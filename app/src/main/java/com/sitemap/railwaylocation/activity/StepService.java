...
import com.sitemap.railwaylocation.db.StepDataDao;
import com.sitemap.railwaylocation.model.StepEntity;
import com.sitemap.railwaylocation.util.TimeUtil;
...
//        startForeground(110, stepNotification);// 开始前台服务
    ...
    private class MessengerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case RequestCode.MSG_FROM_CLIENT:
                    try {
                        //这里负责将当前的步数发送出去，可以在界面或者其他地方获取，我这里是在MainActivity中获取来更新界面
                        Messenger messenger = msg.replyTo;
                        Message replyMsg = Message.obtain(null, RequestCode.MSG_FROM_SERVER);
